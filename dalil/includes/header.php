...
<html lang="ar" dir="rtl"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <style>
        ...
        * {
        ...
        /* التصميم الأنيق الفاخر (Elegant Premium Theme) — به قسم علوي ذهبي */
        .card-premium {
            background: #ffffff;
            border-radius: 16px;
            overflow: hidden;
        ...
        /* القسم العلوي الذهبي — لون موحد مع الهيدر */
        .premium-header {
            background: #c5a880;
            color: white;
        ...
        .premium-header-organizer i {
            color: #1d0f3a;
        }

        .premium-header-badge {
            background: rgba(29, 15, 58, 0.15);
            border: 1px solid rgba(29, 15, 58, 0.2);
            color: #1d0f3a;
            padding: 2px 10px;
            border-radius: 4px;
            font-size: 0.75rem;
        ...
        /* تنسيقات البرامج المنتهية الصلاحية */
        .program-card.ended,
        .card-premium.ended {
            position: relative;
        ...
        /* ==========================================================================
           أنماط الجداول المتوافقة مع الثيمات
           ========================================================================== */
        
        /* النمط الفاخر الأنيق للجدول (Style 3) */
        ...
        /* منبثق نمط الفاخر الأنيق (Style 3) للخريطة */
        ...
        /* ============================================================
           الهيدر — خلفية ذهبية، نصوص داكنة
           ============================================================ */
        body.theme-premium header {
            background: #c5a880;
        }

        body.theme-premium header .logo-text,
        body.theme-premium header .logo-subtext {
            color: #1d0f3a;
        }
        ...
        body.theme-premium nav a.active {
            background: rgba(29, 15, 58, 0.12);
        }

        /* ============================================================
           الهيرو — تدرج ذهبي-داكن
           ============================================================ */
        body.theme-premium .hero {
            background: linear-gradient(rgba(197, 168, 128, 0.85), rgba(197, 168, 128, 0.7)), url('https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1500&q=80');
        }
        ...
        body.theme-premium .hero p {
            color: rgba(29, 15, 58, 0.85);
        }

        body.theme-premium .hero .search-box {
            background: rgba(29, 15, 58, 0.15);
        }

        body.theme-premium .hero .search-box input {
            border: 1px solid rgba(29, 15, 58, 0.2);
            background: #fff;
        }

        body.theme-premium .hero .search-box button {
            background: #1d0f3a;
            color: #ffffff;
        }

        body.theme-premium .hero .search-box button:hover {
            background: #2d1f5a;
            color: #ffffff;
        }
        ...
        /* ============================================================
           الفلاتر
           ============================================================ */
        body.theme-premium .filters-section {
        ...
        body.theme-premium .section-title::after {
            background: #c5a880;
        }

        body.theme-premium .filter-group h3 {
            color: #1d0f3a;
        }

        body.theme-premium .filter-group h3 i {
            color: #c5a880;
        }

        body.theme-premium .filter-group select {
            border: 1px solid #d5d0de;
            color: #3a3650;
        }

        body.theme-premium .filter-group select:focus {
            border-color: #c5a880;
        }

        body.theme-premium .filter-group.search-filter-group .search-box {
            border-color: #c5a880;
        }
        body.theme-premium .filter-group.search-filter-group .search-box button {
            background: #1d0f3a;
        }
        body.theme-premium .filter-group.search-filter-group .search-box button:hover {
            background: #2d1f5a;
        }

        /* ============================================================
           أزرار عرض البطاقات/الجدول/الخريطة
           ============================================================ */
        body.theme-premium .view-controls {
            background-color: rgba(197, 168, 128, 0.12);
            border-color: rgba(197, 168, 128, 0.2);
        }
        body.theme-premium .view-controls .view-toggle-btn {
            color: #3a3650;
        }
        body.theme-premium .view-controls .view-toggle-btn:not(.active):hover {
            background-color: rgba(197, 168, 128, 0.15);
            color: #1d0f3a;
        }
        body.theme-premium .view-controls .view-toggle-btn.active {
            background: #1d0f3a;
            color: #c5a880;
            box-shadow: 0 4px 12px rgba(29, 15, 58, 0.2);
        }

        body.theme-premium .direction-heading {
            color: #1d0f3a;
            border-bottom-color: #c5a880;
        }

        body.theme-premium .table-responsive-wrapper {
            background: #fcfbfd;
        }

        /* ============================================================
           الفوتر — خلفية ذهبية، نصوص داكنة
           ============================================================ */
        ...
        body.theme-premium footer .copyright {
            color: rgba(29, 15, 58, 0.7);
            border-top-color: rgba(29, 15, 58, 0.2);
        }

        body.theme-premium .footer-col h3 {
            color: #1d0f3a;
        }

        body.theme-premium .footer-col h3::after {
            background: #1d0f3a;
        }

        body.theme-premium .footer-links a {
            color: rgba(29, 15, 58, 0.8);
        }
        ...
        body.theme-premium .footer-col .footer-links li > i {
            color: #1d0f3a;
        }

        body.theme-premium .footer-col ul.footer-header-nav a {
            color: rgba(29, 15, 58, 0.8);
        }

        body.theme-premium .footer-col ul.footer-header-nav a i {
            color: #1d0f3a;
        }

        body.theme-premium .footer-col ul.footer-header-nav a:hover {
            color: #1d0f3a;
        }

        body.theme-premium .social-link {
            background: rgba(29, 15, 58, 0.15);
        }

        body.theme-premium .social-link:hover {
            background: #1d0f3a;
        }
        
        /* ============================================================
           الخريطة — علامات نبض بنفسجية داكنة
           ============================================================ */
        body.theme-premium .pulse-dot {
            background-color: #1d0f3a;
            box-shadow: 0 0 6px rgba(29, 15, 58, 0.6);
        }
        body.theme-premium .pulse-ring {
            border-color: #1d0f3a;
            background-color: rgba(29, 15, 58, 0.15);
        }
        body.theme-premium .pulsating-icon-container:hover .pulse-dot {
        ...
        /* ============================================================
           منبثقات الخريطة
           ============================================================ */
        body.theme-premium .map-popup-card .popup-organizer i {
            color: #c5a880;
        }
        body.theme-premium .map-popup-card .popup-detail-item i {
            color: #c5a880;
        }
        body.theme-premium .map-popup-card .popup-price-value {
            color: #1d0f3a;
        }
        body.theme-premium .map-popup-card .popup-register-btn {
            background: #1d0f3a;
        }
        body.theme-premium .map-popup-card .popup-register-btn:hover {
            background: #c5a880;
        }
    </style>
</head>
<body class="theme-<?php echo ($site_settings['active_card_style'] ?? '0') == '3' ? 'premium' : 'default'; ?>">
    <header>
