...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $debug['user_data'] = $user ? ['id' => $user['id'], 'username' => $user['username'], 'password_hash_start' => substr($user['password'], 0, 10)] : null;
...
<body>
    ...
    <script>
        ...
        document.getElementById('login-form').addEventListener('submit', function(e) {
            ...
            console.log('Remember Me:', document.querySelector('input[name="remember"]').checked);
            console.groupEnd();
        });
    </script>
</body>
